export CAD_PATH=$PWD/Data/black_cup/black_cup_mesh/black_cup_tre.obj    # path to a given cad model(mm)
...
export OUTPUT_DIR=$PWD/Data/black_cup/sam_tmp        # path to a pre-defined file for saving results
